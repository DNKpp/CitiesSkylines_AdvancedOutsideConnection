...
namespace AdvancedOutsideConnection
{
	...
	class TableRowComponent : UICustomControl
	{
		...
		private bool m_AlwaysBrightBgColor = false;

		public bool AlwaysBrightBgColor
		{
			get
			{
				return m_AlwaysBrightBgColor;
			}
			set
			{
				m_AlwaysBrightBgColor = value;
				SetBackgroundColor();
			}
		}
		...
		public void SetBackgroundColor()
		{
			...
			backgroundColor.a = (byte)((component.zOrder % 2 != 0 || m_AlwaysBrightBgColor) ? 127 : 255);
